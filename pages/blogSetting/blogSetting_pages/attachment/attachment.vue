		...
		<view class="block">
			...
			<view v-if="attachment_typeText[attachment_typeIndex] === '又拍云'">
				...
				<view class="view-input">
					...
					<input class="input" type="text" v-model="oss_upyun_domain"
			...
			<view v-if="attachment_typeText[attachment_typeIndex] === '七牛云'">
				...
				<view class="view-input">
					<view class="view-input-titleView"><text style="color: red;">*</text>绑定域名：</view>
					<input class="input" type="text" v-model="oss_qiniu_domain"
						placeholder="无需再加上 http:// 或者 https://" />
				</view>
			...
			<view v-if="attachment_typeText[attachment_typeIndex] === '阿里云'">
				...
				<view class="view-input">
					...
					<input class="input" type="text" v-model="oss_ali_domain"
			...
			<view v-if="attachment_typeText[attachment_typeIndex] === '百度云'">
				...
				<view class="view-input">
					<view class="view-input-titleView">绑定域名：</view>
					<input class="input" type="text" v-model="bos_baidu_domain"
						placeholder="如不填写,路径根域名将为 Bucket + EndPoint" />
				</view>
			...
			<view v-if="attachment_typeText[attachment_typeIndex] === '腾讯云'">
				...
				<view class="view-input">
					<view class="view-input-titleView">绑定域名：</view>
					<input class="input" type="text" v-model="cos_tencent_domain"
						placeholder="如不填写,路径根域名将为 Bucket + EndPoint" />
				</view>
				...
				<view class="view-input">
					<view class="view-input-titleView">区域：</view>
					<view class="input">
						<picker @change="cosTencentRegionChange" :value="cos_tencent_regionIndex"
							:range="cos_tencent_regionText">
			...
			<view v-if="attachment_typeText[attachment_typeIndex] === '华为云'">
				...
				<view class="view-input">
					<view class="view-input-titleView">绑定域名：</view>
					<input class="input" type="text" v-model="obs_huawei_domain"
						placeholder="如不填写,路径根域名将为 Bucket + EndPoint" />
				</view>
	...
	export default {
		data() {
			return {
				...
				cos_tencent_regionValue: ["ap-beijing-1", "ap-beijing", "ap-shanghai", "ap-guangzhou", "ap-chengdu",
					"ap-chongqing"
				],
		...
		methods: {
			...
			refreshData: function() {
				...
				getOptionsByMapViewsKeys(array).then(data => {
					...
					that.cos_tencent_domain_protocolIndex = that.cos_tencent_domain_protocolValue
						.indexOf(
					...
					that.obs_huawei_domain_protocolIndex = that.obs_huawei_domain_protocolValue
						.indexOf(
			...
			saving: function() {
				...
				let json = {
					...
					"attachment_type": this.attachment_typeValue[this.attachment_typeIndex],


					"smms_api_secret_token": this.smms_api_secret_token,

					"oss_upyun_domain_protocol": this.oss_upyun_domain_protocolValue[this
						.oss_upyun_domain_protocolIndex],
					...
					"oss_qiniu_domain_protocol": this.oss_qiniu_domain_protocolValue[this
						.oss_qiniu_domain_protocolIndex],
					"oss_qiniu_domain": this.oss_qiniu_domain,
					"oss_qiniu_zone": this.oss_qiniu_zoneValue[this.oss_qiniu_zoneIndex],
					...
					"oss_ali_domain_protocol": this.oss_ali_domain_protocolValue[this
						.oss_ali_domain_protocolIndex],
					...
					"bos_baidu_domain_protocol": this.bos_baidu_domain_protocolValue[this
						.bos_baidu_domain_protocolIndex],
					...
					"cos_tencent_domain_protocol": this.cos_tencent_domain_protocolValue[this
						.cos_tencent_domain_protocolIndex],
					"cos_tencent_domain": this.cos_tencent_domain,
					"cos_tencent_bucket_name": this.cos_tencent_bucket_name,
					"cos_tencent_region": this.cos_tencent_regionValue[this.cos_tencent_regionIndex],
					...
					"obs_huawei_domain_protocol": this.obs_huawei_domain_protocolValue[this
						.obs_huawei_domain_protocolIndex],
